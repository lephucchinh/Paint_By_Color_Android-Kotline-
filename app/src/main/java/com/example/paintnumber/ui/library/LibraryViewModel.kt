	...
	private fun loadBanners() {
		val dummyBanners = listOf(
			Banner(
				...
				title = "Tỏa sức sáng tạo của bạn",
				description = "Khám phá những bức tranh mới nhất"
			),
			Banner(
				id = "2",
				imageResId = R.drawable.banner_2,
				title = "Chủ đề đặc sắc",
				description = "Trải nghiệm tranh nổi bật tuần này"
			),
			Banner(
				id = "3",
				imageResId = R.drawable.banner_3,
				title = "Khám phá mới",
				description = "Nội dung mới vừa cập nhật"
			)
		)
